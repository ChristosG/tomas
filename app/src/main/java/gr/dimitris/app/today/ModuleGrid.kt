...
/**
 * The practice tiles on Today: two columns, and small enough that the modules there are now — nine,
 * once the arcade and sing-then-say are switched on, with «SQL» and «Βήματα» since phase 13 — fit on a
 * phone screen under the greeting.
 *
