...
class ClaudeAdvisor(private val secrets: Secrets, private val model: suspend () -> String) {
    ...
    companion object {
        ...
        val SYSTEM_PROMPT = """
            ...
            - Γράψε: 1 κεφαλαία, 2 μικρά, 3 λέξεις με το δάχτυλο (και από μνήμης, όταν γράψει μια
              λέξη χωρίς βοήθεια), 4 υπαγόρευση — ακούει τη λέξη, δεν τη βλέπει, και τη γράφει
              γράμμα-γράμμα, 5 γράφει ολόκληρη πρόταση στο πληκτρολόγιο για μια εικόνα (μόνο όταν
              είναι ανοιχτός ο «Έλεγχος με Claude»)
            - Διάλογοι: πόσο δύσκολο διάλογο δέχεται — η κουκκίδα n παίρνει τους διαλόγους μέχρι και
              το επίπεδο n
            - Τραγούδα και πες το: μέχρι πόσες συλλαβές έχει η φράση — 5, 7, 9, 11, όσες να 'ναι.
              Από τη φάση 13 η ενότητα είναι για ολόκληρες καθημερινές προτάσεις, που τις τραγουδάει
              σε ανάσες των έξι συλλαβών
            - Δεξί χέρι: πόσο μικρός γίνεται ο στόχος
            - Βήματα: η κουκκίδα n παίρνει τις δουλειές μέχρι και τη δυσκολία n — 1 τρία βήματα,
              2 τέσσερα, 3 πέντε, 4 έξι, 5 έξι και ένα βήμα που ανήκει σε άλλη δουλειά· η συνεδρία
              διαλέγει πρώτα δουλειά της κουκκίδας του και μετά πιο εύκολες
            - SQL: η κουκκίδα n παίρνει τα επίπεδα μέχρι και το n — 1 βάζει τις λέξεις της ερώτησης
              ...
              λείπει, 4 γράφει ο ίδιος την ερώτηση, 5 δύο πίνακες μαζί (JOIN)· όταν πατάει μια
              κουκκίδα, το επίπεδό του πάει εκεί (μέσα στα όρια που έβαλες)
